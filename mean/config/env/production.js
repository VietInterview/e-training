...
module.exports = {
  port: process.env.PORT || 8448,
  // Binding to 127.0.0.1 is safer in production.
  host: process.env.HOST || '0.0.0.0',
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/etraining-nissan',
    options: {
      user: '',
      pass: ''
    },
  ...
  secure: {
    ...
    certificate: '/etc/letsencrypt/live/nissan.vietinterview.com/fullchain.pem'
  },
  log: {
