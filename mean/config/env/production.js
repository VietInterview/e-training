...
module.exports = {
  ...
  secure: {
    ssl: true,
    privateKey: process.env.ETRAINING_PRIVATE_KEY || '/etc/letsencrypt/live/daotao.vietinterview.com/private.pem',
    certificate: process.env.ETRAINING_CERTIFICATE || '/etc/letsencrypt/live/daotao.vietinterview.com/fullchain.pem'
  },
  log: {
