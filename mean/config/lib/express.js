...
module.exports.initLocalVariables = function(app) {
  ...
  app.locals.logo = config.logoUrl;
  app.locals.appClass = config.appClass;
  app.locals.bodyClass = config.bodyClass;
  app.locals.favicon = config.faviconUrl;
...
module.exports.initMiddleware = function(app) {
  ...
  app.use(favicon(config.faviconFile));
